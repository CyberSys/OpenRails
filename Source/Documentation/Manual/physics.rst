...
Multiple Units of Engines in Same Consist
=========================================
...
- Move To Back -- ``<Ctrl+I>``: Move one locomotive group to back (*async*) 
  control group.
- Move To Front -- ``<Ctrl+O>``: Move one locomotive group to front (*sync*) 
  control group.
- Traction -- ``<Ctrl+L>``: Switch *async* group to traction mode.
- Idle -- ``<Ctrl+K>``: Switch *async* group to idle.
- Brake -- ``<Ctrl+J>``: Switch *async* group to dynamic braking mode.
- More -- ``<Ctrl+U>``: Increase *async* group traction or dynamic brake, 
  depending on its mode setting.
- Less -- ``<Ctrl+N>``: Decrease *async* group traction or dynamic brake, 
  depending on its mode setting.
